...
function App() {
  ...
  useEffect(() => {
    async function getList() {
      let list = await fetch("https://list-anything-v2.herokuapp.com/list")
  ...
  const handleSubmit = async (e) => {
    ...
    async function addToList(dataToSend) {
      let add = await fetch("https://list-anything-v2.herokuapp.com/list", {
        method: "POST",
        headers: {
  ...
  const handleDelete = async (e, itemToDelete) => {
    ...
    async function deleteData(dataToDelete) {
      let deleteData = await fetch(
        "https://list-anything-v2.herokuapp.com/list",
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",

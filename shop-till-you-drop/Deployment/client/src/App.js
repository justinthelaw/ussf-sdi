...
export default function App() {
  ...
  const [baseURL] = useState(
    NODE_ENV === "development"
      ...
      : `https://shop-till-you-drop.herokuapp.com`
  );
    ...
    <div>
      ...
      <footer className={classes.root}>
        ...
        <AppBar position="fixed" className={classes.appBar}>
          ...
          >
            <Tooltip title="> 💻 For app info or suggestions, click on the GitHub button > 🤝 To get to know me, click on the LinkedIn button">
              <Typography
                variant="body2"
                noWrap
                style={{
